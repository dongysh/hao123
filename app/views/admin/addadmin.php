							...
							<div class="portlet-body form">
								...
								<form action="" id="add_user_form" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">管理员密码<span class="required">*</span></label>
											...
											<select class="span6 m-wrap" name="game">
												...
												<?php if(isset($gamelist)): ?>
													...
													<?php foreach ($gamelist as $k=>$v):?>
														...
														<option value="<?php echo $v['game_id']; ?>"><?php echo $v['title']; ?></option>
		...
		$(document).ready(function(){
			...
			form1.validate({
                ...
                submitHandler: function (form) {
                    success1.show();
                    error1.hide();
                    var data = $("#add_user_form").formToArray();
					$.ajax({
						type: "POST",
						url:  "<?=ADMIN_PATH?>/admin/addAdmin",
						data: data,
						dataType: 'json',
