...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-body form">
								...
								<form action="" id="update_user_pwd_form" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">新用户密码<span class="required">*</span></label>

										<div class="controls">

											<input name="password" id="passowrd" type="password" class="span6 m-wrap"/>
									...
									<input type="hidden" name="action" value="updatePwdAction"/>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var form1 = $('#update_user_pwd_form');
			...
			form1.validate({
	            ...
	            messages: {
	                password: {
	                	minlength: "密码至少要输入5个字符",
                        maxlength: "密码最多可输入20个字符",
	                    required: "请输入新密码"
	                },
	                repassword: {
	                	required: "请输入确认密码",
                ...
                submitHandler: function (form) {
                    success1.show();
                    error1.hide();
                    var data = $("#update_user_pwd_form").formToArray();
					$.ajax({
						type: "POST",
						url:  "/admin/admin/changepwd",
						data: data,
						dataType: 'json',
