					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>更新游戏</div>
								...
								<form action="<?=ADMIN_PATH?>/game/updategame/<?=$gameInfo['game_id']?>" method="post" id="update_game_form" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="title" data-required="1" class="span6 m-wrap" value="<?=$gameInfo['title']; ?>"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="website" data-required="1" class="span6 m-wrap" value="<?=$gameInfo['website']; ?>" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="type">
												...
												<option value="<?php echo ($k+1);?> " <?php if(($k+1) == $gameInfo['type']): ?> selected <?php endif; ?> ><?php echo $v; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="painting">
												...
												<option value="<?php echo ($k+1);?>" <?php if(($k+1) == $gameInfo['painting']): ?> selected <?php endif; ?> ><?php echo $v; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="style">
												...
												<option value="<?php echo ($k+1); ?>" <?php if(($k+1) == $gameInfo['style']): ?> selected <?php endif; ?> ><?php echo $v; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="status">
												...
												<option value="<?php echo ($k+1);?>" <?php if(($k+1) == $gameInfo['status']): ?> selected <?php endif; ?> ><?php echo $v; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="ctg">
												...
												<option value="<?php echo ($k+1);?>" <?php if(($k+1) == $gameInfo['ctg']): ?> selected <?php endif; ?> ><?php echo $v; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="operator">
												...
												<option value="<?php echo $v['operator_id'];?>" <?php if($v['operator_id'] == $gameInfo['operator']): ?> selected <?php endif; ?> ><?php echo $v['operator_name']; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="research">
												...
												<option value="<?php echo $v['research_id'];?>" <?php if($v['research_id'] == $gameInfo['research']): ?> selected <?php endif; ?> ><?php echo $v['research_name']; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="origin">
												...
												<option value="<?php echo ($k+1);?>" <?php if(($k+1) == $gameInfo['origin']): ?> selected <?php endif; ?> ><?php echo $v; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="card_group">
												...
												<option value="<?php echo ($k+1);?>" <?php if(($k+1) == $gameInfo['card_group']): ?> selected <?php endif; ?> ><?php echo $v; ?></option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea class="span6 m-wrap" name="desc" rows="3"><?php echo $gameInfo['desc'] ?></textarea>
